...
- Install *mercury* by typing the following in the terminal window: ```pip install mercury==2.4.3``` (pinned: the notebooks use mercury 2.4.3's CLI and widget API, which changed in later versions)
